...
class Test():
    ...
    def test_case(self):
        ...
        WebDriverWait(self.driver, 20).until(EC.element_to_be_clickable((By.XPATH, "/html/body/qa-root/qa-dashboard/qa-header/div/div[2]/div/button[2]/span/span"))).click()
        WebDriverWait(self.driver, 20).until(EC.element_to_be_clickable((By.XPATH, "//*[@id=\"cdk-overlay-0\"]/div/div/button"))).click()


        time.sleep(5)
        # Отримаемо значення з сторінки singin:
        text_all_singin_check = self.driver.find_element("xpath", "/html/body/qa-root/qa-sign-in/div/div/div[1]/div/h2")
